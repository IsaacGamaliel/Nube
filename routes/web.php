...
Route::get('plan/agregar', 'Admin\PlanController@create')
		->name('plan.create');

Route::patch('plan/agregar', 'Admin\PlanController@store')
		->name('plan.store');

Route::get('plan/{id}/editar', 'Admin\PlanController@edit')
		->name('plan.edit');

Route::get('plan/{id}', 'Admin\PlanController@show')
		->name('plan.show');

Route::patch('plan/{id}/editar', 'Admin\PlanController@update')
		->name('plan.update');

Route::patch('plan/{id}/eliminar', 'Admin\PlanController@destroy')
		->name('plan.destroy');
