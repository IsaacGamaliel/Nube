        ...
        <section class="jumbotron bg text-center mb-0">
            <div class="row pt-5 bg-home">
                <div class="col-sm-12 col-md-12 col-lg-6 pt-5 text-left">
                    ...
                    <div class="container">
                        <h5 class="title-home pt-5 ml-5">Almacena tus archivos <br> con más eficiencia y <b>seguridad</b>
                        </h5>
        ...
        @if (session('info'))
            <div class="container">
                <div class="alert alert-{{ session('info')[0] }}" role="alert">
                    ...
                    <strong></strong>{{ session('info')[1] }}</strong>
                </div>
            </div>
        @endif
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body text-left">
                                    ...
                                    @guest
                                        ...
                                        <a href="{{ route('login') }}"
                                            class="btn btn-lg btn-block btn-outline-info">Ingresar</a>
                                    @else
                                            ...
                                            @else
                                                <form action="{{ route('subscription.store') }}" method="POST">
                                                    ...
                                                    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                                        data-key="{{ config('services.stripe.key') }}" data-name="Suscripción a iNube" data-amount="{{ $plan->amount }}"
                                                        data-description="Suscripción mensual" data-label="Seleccionar plan" data-email="{{ Auth()->user()->email }}"
                                                        data-image="{{ asset('img/logito_Dark.png') }}" data-locale="auto"></script>
                                                </form>
                                                @endif
                                            @else
