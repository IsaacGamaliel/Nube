...
<form class="was-validated" action="{{ route('plan.update',Crypt::encrypt($plan->id)) }}" method="POST">
	...
	<div class="form-row">
		...
		<div class="col-sm-6 mb-3">
			...
			<textarea name="plan_description" class="form-control is-valid" id="details" rows="7" placeholder="{{ $plan->plan_description }}" required></textarea>
			<div class="invalid-feedback">¡Debes agregar los detalles del plan!</div>
		</div>

		<div class="col-sm-12 mb-3">
			<div class="alert alert-warning">
				Copiar el código de abajo para no dejar los detalles en blanco.
			</div>
		</div>
