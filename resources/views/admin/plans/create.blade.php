...
<form class="was-validated" action="{{ route('plan.store') }}" method="POST">
	...
	<div class="form-row">
		...
		<div class="col-sm-6 mb-3">
			...
			<textarea name="plan_description" class="form-control is-valid" id="details" rows="3" required>
			</textarea>
		...
		<div class="col-sm-6 mb-3">
			...
			<input type="text" name="plan_type" class="form-control is-valid" id="PlanType" placeholder="BSMonthly" required>
		...
		<div class="col-sm-6 mb-3">
			...
			<input type="text" name="name" class="form-control is-valid" id="ModalName" placeholder="Buffalo Safe" required>
