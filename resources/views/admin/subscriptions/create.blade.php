...
<form class="was-validated" action="{{ route('plan.store') }}" method="POST">
	...
	<div class="form-row">
		...
		<div class="col-sm-6 mb-3">
			...
			placeholder="Todos los elementos incluidos en la descripción" rows="3" required></textarea>
			<div class="invalid-feedback">¡Debes agregar detalles al plan</div>
		</div> 

		<div class="col-sm-12 mb-3">
            <div class="alert alert-warning">
                El siguiente código es un ejemplo para la descripción del plan.
            </div>
        </div>
        <div class="col-sm-12 mb-3">
            <div class="container">
                <code>&ltli&gt&lt i class="fas fa-headset"&gt&lti&gt20 GB de almacenamiento&lt/li&gt</code>
            </div>
        </div>
		...
		<div class="col-sm-6 mb-3">
			...
			<input type="text" name="plan_type" class="form-control is-valid" id="PlanType" placeholder="iNube" required>
		...
		<div class="col-sm-6 mb-3">
			...
			<input type="text" name="name" class="form-control is-valid" id="ModalName" placeholder="iNube" required>
		...
		<div class="col-sm-6 mb-3">
			...
			<input type="text" name="btn_label" class="form-control is-valid" id="bntText" placeholder="Suscribirse" required>
