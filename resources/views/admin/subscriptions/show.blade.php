...
<div class="form-row">
	...
	<div class="col-sm-6 mb-3">
		...
		rows="7" placeholder="{{$plan->plan_description}}" disabled></textarea>
	...
	<div class="col-sm-6 mb-3">
		...
		<input type="text" name="btn_label" class="form-control is-valid" id="bntText" value="{{$plan->btn_label}}" disabled>
