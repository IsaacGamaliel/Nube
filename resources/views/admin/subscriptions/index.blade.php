...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-12 mb-5">
			<a class="btn btn-outline-success" href="{{ route('plan.create') }}"><i class="fas fa-plus-circle"></i>
				Agregar un plan</a>
		</div>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<th scope="row">
							<a class="btn btn-outline-success" href="{{ route('plan.show', $plan->id) }}"><i
									class="fas fa-eye"></i> Ver</a>
						</th>

						<th scope="row">
							<a class="btn btn-outline-primary" href="{{ route('plan.edit', $plan->id) }}"><i
