                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name" type="text"
                                                ...
                                                name="name" value="{{ old('name') }}" maxlength="50" minlength="10"
                                                required autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="username" type="text"
                                                ...
                                                name="username" value="{{ old('username') }}" maxlength="20"
                                    ...
                                    <div class="form-group row">
                                        <label for="image" class="col-md-4 col-form-label text-md-right">{{ __('Imagen')
                                            }}</label>
