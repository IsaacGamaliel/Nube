    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top alert-home">
            <a href="#" class="navbar-brand">
                <img src="{{asset('img/logo_Sin_fondo.png')}}" alt="30" height="30" class="d-inline-block aling-top"
                    alt="">
                ¡Nube
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="https://example.com" id="dropdown06"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Más información</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="color: #000;" href="{{ route('file.create') }}">Subir tus
                            archivos</a>
                    </li>
                    @endif
                    @if(Auth::user()->hasRole('Admin'))
                    <li class="nav-item">
                        <a class="nav-link" style="color: #000;" href="{{ route('dashboard') }}">Panel
                            administrativo</a>
                    </li>
                    @endif
                    <li>
    ...
    <footer class="container py-5">
        <div class="row">
            <div class="col-12 col-md">
                <img src="{{asset('img/logo_Sin_fondo.png')}}" width="100">
                <small class="d-block mb-3 text-muted text-left">® ¡Nube</small>
            </div>
            ...
            <div class="col-sm-6 col-md-3 text-right">
                ...
                <img class="img-fluid"
                    src="http://3.bp.blogspot.com/-oumQWdMsBL8/Vh94mt2nYLI/AAAAAAAAANQ/qPwSgz1YgJc/s400/Payment%2BCard%2BNetworks%2BLogo.jpg"
                    width="220">
            </div>
    </footer>
